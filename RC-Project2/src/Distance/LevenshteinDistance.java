...
public class LevenshteinDistance implements EditDistance<Integer>
{
    ...
    public Integer compare(String one, String two) {
        if (threshold != null) {
            return limitedCompare(one, two, threshold);
        }
        return unlimitedCompare(one, two);
    }
     ...
     * @return result distance, or -1
     */
    private static int limitedCompare(String left, String right, final int threshold) { // NOPMD
        if (left == null || right == null) {
            throw new IllegalArgumentException("Strings must not be null");
        }
        if (threshold < 0) {
     ...
     * @throws IllegalArgumentException if either String input {@code null}
     */
    private static int unlimitedCompare(String left, String right) {
        if (left == null || right == null) {
            throw new IllegalArgumentException("Strings must not be null");
        }
